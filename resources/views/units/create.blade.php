...
<body>
    ...
    <form action="{{ url('units/submit') }}" method="post" class="w-1/2 m-auto border rounded-xl p-10">
        ...
        <div class="flex flex-col items-start justify-center mb-10">
            ...
            <input type="text" name="unitName" id="unitName" placeholder="اسم درستو بنویس دایی" class="outline-none w-full px-5 py-3 border-b">
        </div>
        <div class="flex flex-col items-start justify-center mb-10">
            <label for="unitCount" class="mb-3 font-semibold text-lg"> تعداد واحد :</label>
            <input type="text" name="unitCount" id="unitCount" placeholder="تعداد واحدشو بنویس دایی" class="outline-none w-full px-5 py-3 border-b">
        </div>
